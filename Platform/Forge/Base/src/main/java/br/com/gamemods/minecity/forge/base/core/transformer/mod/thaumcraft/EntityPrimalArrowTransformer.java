...
@MethodPatcher
@Referenced
public class EntityPrimalArrowTransformer extends BasicTransformer
{
    @Referenced("br.com.gamemods.minecity.forge.mc_1_7_10.core.MineCitySevenCoreMod")
    public EntityPrimalArrowTransformer()
    {
        super("thaumcraft.common.entities.projectile.EntityPrimalArrow");
    }
    ...
    protected void patch(String name, ClassNode node, ClassReader reader)
    {
        ...
        {
            if(method.desc.equals("(L"+trace+";)Z"))
            {
