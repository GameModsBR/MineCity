...
public class DepLoader
{
    ...
    public DepLoader(File rootDir, LaunchClassLoader cl, Object[] fmlData, Class<?> loaderClass,
                     Function<String, Comparable> comparableVersion)
    {
        this.loaderClass = loaderClass;
        this.comparableVersion = comparableVersion;
        String mcVer = (String) fmlData[4];
        File mcDir = (File) fmlData[6];
        ...
        depMap = new HashMap<>();
        downloader = new Downloader(rootDir, comparableVersion);
    }
    ...
    private void parseJson(JsonObject node)
    {
        ...
        {
            obfuscated =
                    ((LaunchClassLoader) loaderClass.getClassLoader()).getClassBytes("net.minecraft.world.World") ==
                            null;
        }
        catch(IOException e)
        {
        ...
        VersionedFile versionedFile = new VersionedFile(filename, pattern, comparableVersion);
