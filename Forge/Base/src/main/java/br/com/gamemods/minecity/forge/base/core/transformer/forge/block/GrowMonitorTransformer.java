...
/**
 * Patches all implementations to {@code {@link net.minecraft.block.IGrowable#grow(World, Random, BlockPos, IBlockState)}}
...
public class GrowMonitorTransformer implements IClassTransformer
{
    ...
    public GrowMonitorTransformer(String hookClass)
    {
