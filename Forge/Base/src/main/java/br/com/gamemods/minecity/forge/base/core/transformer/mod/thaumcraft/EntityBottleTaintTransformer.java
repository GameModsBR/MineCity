...
@Referenced
@MethodPatcher
public class EntityBottleTaintTransformer extends BasicTransformer
{
    @Referenced("br.com.gamemods.minecity.forge.mc_1_7_10.core.MineCitySevenCoreMod")
    public EntityBottleTaintTransformer()
    {
        super("thaumcraft.common.entities.projectile.EntityBottleTaint");
    }
