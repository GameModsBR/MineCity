...
public class MineCityMod
{
    ...
    public void onPreInit(FMLPreInitializationEvent event) throws IOException, SAXException
    {
        ...
        forge.onPreInit(new Configuration(event.getSuggestedConfigurationFile()), event.getModLog(), new ForgeTransformer());
    }
    ...
    public void onPostInit(FMLPostInitializationEvent event)
    {
        ...
        FMLCommonHandler.instance().bus().register(new TickListener(forge));
        MinecraftForge.EVENT_BUS.register(new ToolListener(forge));
        MinecraftForge.EVENT_BUS.register(new WorldListener(forge));
    }
