...
{
    @SuppressWarnings({"CheckTagEmptyBody", "CheckDtdRefs"})
    @Language(value = "XML", suffix = "</minecity-messages>")
    private static final String XML_PREFIX =
            "<!DOCTYPE minecity-messages SYSTEM \"https://raw.githubusercontent.com/GameModsBR/MineCity/master/Core/src/main/resources/assets/minecity/messages-base.dtd\" [<!ELEMENT minecity-messages (#PCDATA|msg)>]><minecity-messages>";
