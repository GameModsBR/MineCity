...
public class ChunkPosTest
{
    ...
    {
        assertEquals(new ChunkPos(world, 10, 11),   a.add(Direction.SOUTH));
        assertEquals(new ChunkPos(world, 10, 9),    a.add(Direction.NORTH));
        assertEquals(new ChunkPos(world, 11, 10),   a.add(Direction.EAST));
        assertEquals(new ChunkPos(world, 9, 10),    a.add(Direction.WEST));
        assertEquals(new ChunkPos(world, 10, 12),   a.add(Direction.SOUTH, 2));
        assertEquals(new ChunkPos(world, 10, 12),   a.add(Direction.SOUTH, 2.8));
    ...
    {
        assertEquals(new ChunkPos(world, 10, 9),   a.subtract(Direction.SOUTH));
        assertEquals(new ChunkPos(world, 10, 11),  a.subtract(Direction.NORTH));
        ...
        assertEquals(new ChunkPos(world, 10, 8),   a.subtract(Direction.SOUTH, 2));
        assertEquals(new ChunkPos(world, 10, 7),   a.subtract(Direction.SOUTH, 2.8));
    ...
    {
        assertEquals(new ChunkPos(world, 10, 33), a.apply(Direction.SOUTH, 2.8, (a,b)-> b > 0? (int) Math.round(a*b +5) : a));
        assertEquals(new ChunkPos(world, 10, 25), a.apply(Direction.SOUTH, 2, (a,b)-> b > 0? (int) Math.round(a*b +5) : a));
