...
public class MineCityBukkitPluginTest
{
    private Player joserobjr = mock(Player.class);
    private World world = mock(World.class);
    private MineCityBukkitPlugin plugin = PowerMockito.mock(MineCityBukkitPlugin.class);
    ...
    public void setUp() throws Exception
    {
        ...
        when(joserobjr.hasPermission(anyString())).thenReturn(true);
