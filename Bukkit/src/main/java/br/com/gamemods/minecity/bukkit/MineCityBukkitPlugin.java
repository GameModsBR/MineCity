...
public class MineCityBukkitPlugin extends JavaPlugin
{
    ...
    public void onEnable()
    {
        ...
        try
        {
            ...
            try(InputStream is = MineCityBukkitPlugin.class.getResourceAsStream("/plugin.yml"))
            {
                                    ...
                                    public boolean execute(CommandSender sender, String commandLabel, String[] args)
                                    {
                                        ...
                                        catch (Throwable ex)
                                        {
                                            throw new CommandException("Unhandled exception executing command '"+commandLabel+
                                                    "' in plugin "+MineCityBukkitPlugin.this.getDescription().getFullName(), ex
                                            );
                                        }
